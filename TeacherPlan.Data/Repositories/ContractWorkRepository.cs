...
namespace TeacherPlan.Data.Repositories
{
	...
	/// </summary>
	public class ContractWorkRepository : IContractWorkRepository
	{
        ...
        public ContractWorkRepository(DataContext dataContext)
        {
        ...
        public int Insert(ContractWork item)
        {
        ...
        public void Update(ContractWork item)
        {
        ...
        /// </summary>
        /// <param name="item">Модель экземпляра сущности.</param>
        public void Delete(ContractWork item)
        {
        ...
        public IEnumerable<ContractWork> GetAll()
        {
            return _dataContext.Connection.GetAll<ContractWork>().ToList();
        }
        ...
        public IEnumerable<ContractWork> GetByFilter(Func<ContractWork, bool> filter)
        {
            var data = _dataContext.Connection.GetAll<ContractWork>();
            if (filter != null)
            {
        ...
        public ContractWork GetByID(int id)
        {
            return _dataContext.Connection.Get<ContractWork>(id);
        }
    }
}
