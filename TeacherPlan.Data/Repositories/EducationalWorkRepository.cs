...
namespace TeacherPlan.Data.Repositories
{
    ...
    /// </summary>
    public class EducationalWorkRepository : IEducationalWorkRepository
    {
        private DataContext _dataContext;

        /// <summary>
        /// Конструктор репозитория учебных работ преподавателя.
        /// </summary>
        /// <param name="dataContext">Контекст данных (подключение к базе и транзакция).</param>
        public EducationalWorkRepository(DataContext dataContext)
        {
        ...
        public int Insert(EducationalWork item)
        {
        ...
        public void Update(EducationalWork item)
        {
        ...
        /// </summary>
        /// <param name="item">Модель экземпляра сущности.</param>
        public void Delete(EducationalWork item)
        {
        ...
        public IEnumerable<EducationalWork> GetAll()
        {
            return _dataContext.Connection.GetAll<EducationalWork>().ToList();
        }
        ...
        public IEnumerable<EducationalWork> GetByFilter(Func<EducationalWork, bool> filter)
        {
            var data = _dataContext.Connection.GetAll<EducationalWork>();
            if (filter != null)
            {
        ...
        public EducationalWork GetByID(int id)
        {
            return _dataContext.Connection.Get<EducationalWork>(id);
        }
    }
}
