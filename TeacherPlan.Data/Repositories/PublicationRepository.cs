...
{
    /// <summary>
    /// Репозиторий Печатных трудов за год.
    /// </summary>
    public class PublicationRepository : IPublicationRepository
    {
        ...
        public int Insert(Publication item)
        {
        ...
        /// </summary>
        /// <param name="item">Модель экземпляра сущности.</param>
        public void Delete(Publication item)
        {
        ...
        {
            return _dataContext.Connection.GetAll<Publication>().ToList();
        }
        ...
        public IEnumerable<Publication> GetByFilter(Func<Publication, bool> filter)
        {
            var data = _dataContext.Connection.GetAll<Publication>();
            if (filter != null)
            {
        ...
        {
            return _dataContext.Connection.Get<Publication>(id);
        }
    }
}
