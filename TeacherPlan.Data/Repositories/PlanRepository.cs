...
{
    /// <summary>
    /// Репозиторий планов преподавателя.
    /// </summary>
    public class PlanRepository : IPlanRepository
    {
        ...
        public PlanRepository(DataContext dataContext)
        {
        ...
        {
            return _dataContext.Connection.GetAll<Plan>().ToList();
        }
        ...
        public IEnumerable<Plan> GetByFilter(Func<Plan, bool> filter)
        {
            var data = _dataContext.Connection.GetAll<Plan>();
            if (filter != null)
            {
        ...
        {
            return _dataContext.Connection.Get<Plan>(id);
        }
    }
}
