...
namespace TeacherPlan.Data.Repositories
{
    ...
    public class PlannedWorkRepository : IPlannedWorkRepository
    {
        ...
        public PlannedWorkRepository(DataContext dataContext)
        {
        ...
        public int Insert(PlannedWork item)
        {
        ...
        public void Update(PlannedWork item)
        {
        ...
        /// </summary>
        /// <param name="item">Модель экземпляра сущности.</param>
        public void Delete(PlannedWork item)
        {
        ...
        public IEnumerable<PlannedWork> GetAll()
        {
            return _dataContext.Connection.GetAll<PlannedWork>().ToList();
        }
        ...
        public IEnumerable<PlannedWork> GetByFilter(Func<PlannedWork, bool> filter)
        {
            var data = _dataContext.Connection.GetAll<PlannedWork>();
            if (filter != null)
            {
        ...
        public PlannedWork GetByID(int id)
        {
            return _dataContext.Connection.Get<PlannedWork>(id);
        }
    }
}
