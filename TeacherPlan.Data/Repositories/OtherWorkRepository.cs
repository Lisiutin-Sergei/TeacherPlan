...
namespace TeacherPlan.Data.Repositories
{
	...
	/// </summary>
	public class OtherWorkRepository : IOtherWorkRepository
	{
        ...
        public OtherWorkRepository(DataContext dataContext)
        {
        ...
        public int Insert(OtherWork item)
        {
        ...
        public void Update(OtherWork item)
        {
        ...
        /// </summary>
        /// <param name="item">Модель экземпляра сущности.</param>
        public void Delete(OtherWork item)
        {
        ...
        public IEnumerable<OtherWork> GetAll()
        {
            return _dataContext.Connection.GetAll<OtherWork>().ToList();
        }
        ...
        public IEnumerable<OtherWork> GetByFilter(Func<OtherWork, bool> filter)
        {
            var data = _dataContext.Connection.GetAll<OtherWork>();
            if (filter != null)
            {
        ...
        public OtherWork GetByID(int id)
        {
            return _dataContext.Connection.Get<OtherWork>(id);
        }
    }
}
