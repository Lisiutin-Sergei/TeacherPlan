...
{
    /// <summary>
    /// Репозиторий Научных кружков.
    /// </summary>
    public class ScienceGroupRepository : IScienceGroupRepository
    {
        ...
        public ScienceGroupRepository(DataContext dataContext)
        {
        ...
        public int Insert(ScienceGroup item)
        {
        ...
        public void Update(ScienceGroup item)
        {
        ...
        /// </summary>
        /// <param name="item">Модель экземпляра сущности.</param>
        public void Delete(ScienceGroup item)
        {
        ...
        public IEnumerable<ScienceGroup> GetAll()
        {
            return _dataContext.Connection.GetAll<ScienceGroup>().ToList();
        }
        ...
        public IEnumerable<ScienceGroup> GetByFilter(Func<ScienceGroup, bool> filter)
        {
            var data = _dataContext.Connection.GetAll<ScienceGroup>();
            if (filter != null)
            {
        ...
        public ScienceGroup GetByID(int id)
        {
            return _dataContext.Connection.Get<ScienceGroup>(id);
        }
    }
}
