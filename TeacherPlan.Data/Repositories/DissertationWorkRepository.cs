...
namespace TeacherPlan.Data.Repositories
{
	...
	/// </summary>
	public class DissertationWorkRepository : IDissertationWorkRepository
	{
        ...
        public DissertationWorkRepository(DataContext dataContext)
        {
        ...
        public int Insert(DissertationWork item)
        {
        ...
        public void Update(DissertationWork item)
        {
        ...
        /// </summary>
        /// <param name="item">Модель экземпляра сущности.</param>
        public void Delete(DissertationWork item)
        {
        ...
        public IEnumerable<DissertationWork> GetAll()
        {
            return _dataContext.Connection.GetAll<DissertationWork>().ToList();
        }
        ...
        public IEnumerable<DissertationWork> GetByFilter(Func<DissertationWork, bool> filter)
        {
            var data = _dataContext.Connection.GetAll<DissertationWork>();
            if (filter != null)
            {
        ...
        public DissertationWork GetByID(int id)
        {
            return _dataContext.Connection.Get<DissertationWork>(id);
        }
    }
}
